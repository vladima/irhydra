...
declare module 'electron/@common' {
	...
	export type ClipboardType = '' | 'selection';
	...
	export interface CrashReporterPayload extends Object {
		/**
	...
	export type DisplayMetrics = 'bounds' | 'workArea' | 'scaleFactor' | 'rotation';
	 ...
	 */
	export interface Screen extends NodeJS.EventEmitter {
		/**
		 * Emitted when newDisplay has been added.
		 */
		on(event: 'display-added', listener: (event: ElectronEvent, newDisplay: Display) => void): this;
		/**
		 * Emitted when oldDisplay has been removed.
		 */
		on(event: 'display-removed', listener: (event: ElectronEvent, oldDisplay: Display) => void): this;
		/**
		 * Emitted when one or more metrics change in a display.
		 */
		on(event: 'display-metrics-changed', listener: (event: ElectronEvent, display: Display, changedMetrics: DisplayMetrics[]) => void): this;
		on(event: string, listener: Function): this;
		/**
    ...
    export function hideInternalModules(): void;
}

declare module 'electron/@main' {
	import { NativeImage, EventEmitter, Dimension, Point, Bounds, ElectronEvent } from 'electron/@common';
	 ...
	 */
	export interface App extends NodeJS.EventEmitter {
		/**
		 ...
		 * Note: This is only implemented on OS X.
		 */
		on(event: 'open-file', listener: (event: ElectronEvent, url: string) => void): this;
		/**
		 ...
		 */
		on(event: 'browser-window-blur', listener: (event: ElectronEvent, browserWindow: BrowserWindow) => void): this;
		/**
		 * Emitted when a browserWindow gets focused.
		 */
		on(event: 'browser-window-focus', listener: (event: ElectronEvent, browserWindow: BrowserWindow) => void): this;
		/**
		 * Emitted when a new browserWindow is created.
		 */
		on(event: 'browser-window-created', listener: (event: ElectronEvent, browserWindow: BrowserWindow) => void): this;
		/**
		 ...
		 */
		on(event: 'certificate-error', listener: (event: ElectronEvent,
		 ...
		 */
		on(event: 'select-client-certificate', listener: (event: ElectronEvent,
			webContents: WebContents,
			url: string,
		 ...
		 */
		on(event: 'login', listener: (event: ElectronEvent,
			webContents: WebContents,
	...
	export type AppPathName = 'home'|'appData'|'userData'|'temp'|'exe'|'module'|'desktop'|'documents'|'downloads'|'music'|'pictures'|'videos';
	...
	export class BrowserWindow extends EventEmitter {
		 ...
		 */
		on(event: 'page-title-updated', listener: (event: ElectronEvent) => void): this;
		/**
		 ...
		 * Note: This is only implemented on OS X.
		 */
		on(event: 'swipe', listener: (event: ElectronEvent, direction: SwipeDirection) => void): this;
		on(event: string, listener: Function): this;
	...
	export type ThumbarButtonFlags = 'enabled' | 'disabled' | 'dismissonclick' | 'nobackground' | 'hidden' | 'noninteractive';
	...
	export interface WebContents extends NodeJS.EventEmitter {
		 ...
		 */
		on(event: 'did-fail-load', listener: (event: ElectronEvent, errorCode: number, errorDescription: string, validatedURL: string) => void): this;
		/**
		 * Emitted when a frame has done navigation.
		 */
		on(event: 'did-frame-finish-load', listener: (event: ElectronEvent, isMainFrame: boolean) => void): this;
		/**
		 ...
		 */
		on(event: 'did-get-response-details', listener: (event: ElectronEvent,
			status: boolean,
			newURL: string,
			originalURL: string,
		 ...
		 */
		on(event: 'did-get-redirect-request', listener: (event: ElectronEvent,
			oldURL: string,
			newURL: string,
			isMainFrame: boolean,
			httpResponseCode: number,
		 ...
		 */
		on(event: 'new-window', listener: (event: ElectronEvent,
			url: string,
			frameName: string,
		 ...
		 * or updating the window.location.hash. Use did-navigate-in-page event for this purpose.
		 */
		on(event: 'did-navigate', listener: (event: ElectronEvent, url: string) => void): this;
		/**
		 ...
		 */
		on(event: 'did-navigate-in-page', listener: (event: ElectronEvent, url: string) => void): this;
		/**
		 ...
		 */
		on(event: 'found-in-page', listener: (event: ElectronEvent, result: FoundInPageResult) => void): this;
		/**
		 ...
		 */
		on(event: 'cursor-changed', listener: (event: ElectronEvent, type: CursorType, image?: NativeImage, scale?: number) => void): this;
		on(event: string, listener: Function): this;
		/**
	...
	export type NewWindowDisposition = 'default' | 'foreground-tab' | 'background-tab' | 'new-window' | 'other';
	...
	export type CursorType = 'default' | 'crosshair' | 'pointer' | 'text' | 'wait' | 'help' | 'e-resize' | 'n-resize' | 'ne-resize' | 'nw-resize' | 's-resize' | 'se-resize' | 'sw-resize' | 'w-resize' | 'ns-resize' | 'ew-resize' | 'nesw-resize' | 'nwse-resize' | 'col-resize' | 'row-resize' | 'm-panning' | 'e-panning' | 'n-panning' | 'ne-panning' | 'nw-panning' | 's-panning' | 'se-panning' |'sw-panning' | 'w-panning' | 'move' | 'vertical-text' | 'cell' | 'context-menu' | 'alias' | 'progress' | 'nodrop' | 'copy' | 'none' | 'not-allowed' | 'zoom-in' | 'zoom-out' | 'grab' | 'grabbing' | 'custom';
	...
	export interface SendInputKeyboardEvent extends SendInputEvent {
		keyCode: string;
	}

	export interface SendInputMouseEvent extends SendInputEvent {
		x: number;
		y: number;
	...
	export interface SendInputMouseWheelEvent extends SendInputEvent {
		deltaX?: number;
		deltaY?: number;
		wheelTicksX?: number;
		wheelTicksY?: number;
	 ...
	 */
	export interface Debugger extends NodeJS.EventEmitter {
		/**
		 ...
		 */
		on(event: 'message', listener: (event: ElectronEvent, method: string, params: any) => void): this;
		on(event: string, listener: Function): this;
	}
	...
	export type MenuItemRole = 'undo' | 'redo' | 'cut' | 'copy' | 'paste' | 'selectall' | 'minimize' | 'close';
	export type MenuItemRoleMac = 'about' | 'hide' | 'hideothers' | 'unhide' | 'front' | 'window' | 'help' | 'services';
	 ...
	 * You should not use this module until the ready event of the app module is emitted.
	 */
	export interface PowerMonitor extends NodeJS.EventEmitter {
		/**
	...
	export interface ProtocolCallback {
		(error: number): void;
		(obj: {
			error: number
		}): void;
	...
	export interface FileProtocolCallback extends ProtocolCallback {
		(filePath: string): void;
		(obj: {
			path: string
		}): void;
	...
	export interface BufferProtocolCallback extends ProtocolCallback {
		(buffer: Buffer): void;
		(obj: {
			data: Buffer,
			mimeType: string,
	...
	export interface StringProtocolCallback extends ProtocolCallback {
		(str: string): void;
		(obj: {
			data: Buffer,
			mimeType: string,
	...
	export interface HttpProtocolCallback extends ProtocolCallback {
		(redirectRequest: {
			url: string;
			method: string;
			session?: Object;
	...
	export class Session extends EventEmitter {
		 ...
		 */
		on(event: 'will-download', listener: (event: ElectronEvent, item: DownloadItem, webContents: WebContents) => void): this;
		on(event: string, listener: Function): this;
		/**
	...
	export interface CertificateVerifyProc {
	...
	interface DownloadItem extends NodeJS.EventEmitter {
		 ...
		 */
		on(event: 'done', listener: (event: ElectronEvent, state: 'completed' | 'cancelled' | 'interrupted') => void): this;
		on(event: string, listener: Function): this;
		/**
	 ...
	 */
	export interface Tray extends NodeJS.EventEmitter {
		/**
    ...
    export const contentTracing: ContentTracing;
...
declare module 'electron/@remote' {
	...
	import { BrowserWindow, WebContents, ElectronEvent } from 'electron/@main';
...
declare module 'electron/@render' {
	import { Dimension, NativeImage, ElectronEvent } from 'electron/@common';
	...
	export interface WebViewElement extends HTMLElement {
		 ...
		 */
		loadURL(url: string, options?: remote.LoadURLOptions): void;
		/**
		 ...
		 * @returns The request id used for the request.
		 */
		findInPage(text: string, options?: remote.FindInPageOptions): number;
		/**
		 * Stops any findInPage request for the webview with the provided action.
		 */
		stopFindInPage(action: remote.StopFindInPageAction): void;
		/**
		 * Prints webview's web page. Same with webContents.print([options]).
		 */
		print(options?: remote.PrintOptions): void;
		/**
		 * Prints webview's web page as PDF, Same with webContents.printToPDF(options, callback)
		 */
		printToPDF(options: remote.PrintToPDFOptions, callback: (error: Error, data: Buffer) => void): void;
		/**
		 ...
		 */
		sendInputEvent(event: remote.SendInputEvent): void
		/**
		 * @returns The WebContents associated with this webview.
		 */
		getWebContents(): remote.WebContents;
		/**
		 ...
		 */
		addEventListener(type: 'did-finish-load', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 ...
		 */
		addEventListener(type: 'did-start-loading', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 * Corresponds to the points in time when the spinner of the tab stops spinning.
		 */
		addEventListener(type: 'did-stop-loading', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 ...
		 */
		addEventListener(type: 'dom-ready', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 ...
		 */
		addEventListener(type: 'enter-html-full-screen', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 * Fired when page leaves fullscreen triggered by HTML API.
		 */
		addEventListener(type: 'leave-html-full-screen', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 ...
		 */
		addEventListener(type: 'close', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 ...
		 */
		addEventListener(type: 'crashed', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 * Fired when the gpu process is crashed.
		 */
		addEventListener(type: 'gpu-crashed', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 ...
		 */
		addEventListener(type: 'destroyed', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 * Emitted when media starts playing.
		 */
		addEventListener(type: 'media-started-playing', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 * Emitted when media is paused or done playing.
		 */
		addEventListener(type: 'media-paused', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 * Emitted when a page's theme color changes. This is usually due to encountering a meta tag:
		 * <meta name='theme-color' content='#ff0000'>
		 */
		addEventListener(type: 'did-change-theme-color', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 * Emitted when DevTools is opened.
		 */
		addEventListener(type: 'devtools-opened', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 * Emitted when DevTools is closed.
		 */
		addEventListener(type: 'devtools-closed', listener: (event: Event) => void, useCapture?: boolean): void;
		/**
		 * Emitted when DevTools is focused / opened.
		 */
		addEventListener(type: 'devtools-focused', listener: (event: Event) => void, useCapture?: boolean): void;
		addEventListener(type: string, listener: (event: Event) => void, useCapture?: boolean): void;
	}

	export namespace WebViewElement {
		...
		interface FoundInPageEvent extends Event {
			result: remote.FoundInPageResult;
		}

		interface NewWindowEvent extends Event {
			url: string;
			frameName: string;
			disposition: remote.NewWindowDisposition;
			options: remote.BrowserWindowOptions;
		}
